...
class RegisterForm(forms.Form):
	...
	DateOfBirth=forms.CharField(max_length=100,widget=forms.TextInput(attrs={'class':'form-control'}))   
...
class BookingForm(forms.Form):
	...
	DeliveryDate=forms.CharField(max_length=100,required=True,widget=forms.TextInput(attrs={'class':'form-control'}))
...
class FeedbackForm(forms.Form):
	Comments=forms.MultipleChoiceField(widget=forms.RadioSelect)
	Questions=forms.MultipleChoiceField(widget=forms.RadioSelect)
	Describe_Feedback=forms.CharField(widget=forms.Textarea(attrs={'class':'form-control','row':'5'}),required=True)
